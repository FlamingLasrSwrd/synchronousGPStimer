...
ENTITY spi_slave IS
  GENERIC(
    ...
    d_width : INTEGER := 25);     --data width in bits
  PORT(
...
BEGIN
  ...
  BEGIN
    ...
    --trdy register
    IF(ss_n = '1' AND st_load_en = '1' AND st_load_trdy = '0') THEN  
      trdy <= '0';   --cleared by user logic
    ...
    --roe register
    IF(ss_n = '1' AND st_load_en = '1' AND st_load_roe = '0') THEN
      roe <= '0';   --cleared by user logic
